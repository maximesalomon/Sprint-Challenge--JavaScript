...
console.log("Objects Challenges 👇")
...
graduates.forEach(function(e) {
  if (e.university.includes('Uni')) {
    return uni.push(e.university);
  }
});
...
console.log("Advanced Array Methods Challenges 👇")
...
zooAnimals.forEach(function(e) {
  return animalNames.push("Name: " + e.animal_name + " Scientific: " + e.scientific_name);
});
...
*/
const lowerPopulation = zooAnimals.filter(e => e.population < 5);
...
const populationTotal = zooAnimals.map(e => e.population).reduce(reducer);
